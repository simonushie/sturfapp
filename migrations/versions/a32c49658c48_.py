...
Revision ID: a32c49658c48
Revises: 8f8a40e288c1
Create Date: 2021-02-11 13:12:05.397940
...
revision = 'a32c49658c48'
down_revision = '8f8a40e288c1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('image_file', sa.ARRAY(sa.String(length=1500)), nullable=True),
